...
m->posplay.x= m->back[fullscreen]->w / 45;
...
m->posoption.x=m->back[fullscreen]->w / 45;
...
m->poshigh.x=m->back[fullscreen]->w / 45;
...
m->poshistory.x= m->back[fullscreen]->w / 44;
...
m->posexit.x=m ->back[fullscreen]->w / 45;
